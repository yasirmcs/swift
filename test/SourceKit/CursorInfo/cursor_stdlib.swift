...
func foo2(_ a : inout [S1]) {
  a = a.sorted(orderingBy: { (a, b) -> Bool in
    return false
  })
  a.append(S1())
}
...
// CHECK-REPLACEMENT1: sorted(orderingBy: @noescape (Int, Int) -&gt; Bool) -&gt; [Int]</RelatedName>
...
// CHECK-REPLACEMENT3: func sorted(orderingBy inIncreasingOrder: @noescape (<Type usr="s:V13cursor_stdlib2S1">S1</Type>
// CHECK-REPLACEMENT3: sorted() -&gt; [S1]</RelatedName>
// CHECK-REPLACEMENT3: sorted() -&gt; [S1]</RelatedName>
// CHECK-REPLACEMENT3: sorted(orderingBy: @noescape (S1, S1) -&gt; Bool) -&gt; [S1]</RelatedName>
